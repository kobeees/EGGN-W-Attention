...
from models.utils_models import Conv1d, PointNet_FP_Module, PointNet_SA_Module
from models.utils_models import Transformer
...
class PMPNetPlus(nn.Module):
    ...
    def forward(self, point_cloud):
        ...
        # return [pcd_out_1.permute(0, 2, 1).contiguous(), pcd_out_2.permute(0, 2, 1).contiguous(),
        #         pcd_out_3.permute(0, 2, 1).contiguous()], [delta1, delta2, delta3]
        return pcd_out_1.permute(0, 2, 1).contiguous(), pcd_out_2.permute(0, 2, 1).contiguous(), pcd_out_3.permute(0, 2, 1).contiguous()